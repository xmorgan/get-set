...
/**
    ...
    @param {Boolean} [options.seal] - Indicates whether instances should be sealed.
    @returns {Function}
*/
const createGetSet = (Base, options = {}) => {
    /**
    ...
    */
    return class GetSet extends Base {
        constructor(descriptors, ...rest) {
            super(...rest);
            const self = new Proxy(this, new GetSetHandler(options));
